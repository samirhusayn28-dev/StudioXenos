...
export default function FacebookButton({ href = '#' }) {
  ...
  // On touch devices, hover state doesn't make sense and can get
  // "stuck" after a tap — so keep it always collapsed (minimal icon only)
    ...
    <a href={href} target="_blank" rel="noreferrer" style={{ textDecoration: 'none' }}>
      ...
      >
        <svg
          ...
          height="1.5em"
          viewBox="0 0 24 24"
          style={{ transition: 'opacity 0.3s', opacity: isExpanded ? 0 : 1, flexShrink: 0 }}
        >
